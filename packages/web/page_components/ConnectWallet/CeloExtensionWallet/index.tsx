...
const CeloExtensionWallet: React.FC = () => {
  ...
  useEffectOnce(() =>
    setProvider(PROVIDERS[SupportedProviders.CeloExtensionWallet])
  );
      ...
      <Page contentClassName="c-py-0" title={provider.name}>
        <StaticPageContainer>
          ...
          <div className={styles.content}>
            <div>
              <p>
                Follow the instructions to install {provider.name} from{" "}
                <a href={provider.installURL} target="_blank" rel="noreferrer">
                  chrome.google.com/webstore
                </a>
              </p>
              <h5 className="c-mb-4 font-weight-bold">Finished installing?</h5>
              <p>
              ...
              {provider.canConnect() ? (
                <Button
                  ...
                  className="c-px-5"
                  onClick={() =>
                    setSelectedProvider(SupportedProviders.CeloExtensionWallet)
                  }
                >
                  Connect
                </Button>
              ) : (
                <Button className="c-px-5" onClick={() => router.reload()}>
                  Refresh page
                </Button>
              )}
            </div>
...
export default observer(CeloExtensionWallet);
