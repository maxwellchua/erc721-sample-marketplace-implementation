...
contract Market is IMarket, Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        _eToken = Collectible(collectibleAddress);
        ...
        nonReentrant
    {
        ...
        address tokenOwner = _eToken.ownerOf(tokenId);
        require(
    ...
    function removeTokenFromSale(uint256 tokenId) external nonReentrant {
        ...
        _eToken.removeFromSale(tokenId);
    ...
    function _handlePaymentAndTokenTransfers(
        ...
        (address creator, uint256 royaltyAmount) = _eToken.royaltyInfo(
            tokenId,
            amount
        );
        Fee memory fee = _tokenFees[tokenId];
        ...
        _eToken.marketTransfer(tokenOwner, recipient, tokenId);
    }
